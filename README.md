...
- Chicken-and-egg problems with CloudFormation not reflecting parent/child relationships between resources
    - Some setups may have multi-step deployments, such as first creating a bucket and then uploading an artifact used by other resources. Importing without inspecting the code may flatten this relationship and lose some hidden dependencies.
...
Relevant examples and deployment scripts: https://github.com/vova-ivanov/migration-examples

## Concerns in Relation to Discovered Stacks

Importing works well, and Neo successfully goes from beginning to end with analyzing resources, querying them for information, importing them, fixing CLI-generated code, running `preview`, and submitting a PR.
...
Proof-of-concept implementation branch: [vova/neo-discovered-stacks-migration-tool](https://github.com/pulumi/pulumi-service/tree/vova/neo-discovered-stacks-migration-tool)
